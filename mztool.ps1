...
function MZTOOLMODULE {
    ...
    try { 
        Invoke-RestMethod https://raw.githubusercontent.com/mzti/mztool/main/modules/mztool.psm1 | Out-File -FilePath $Global:MZTOOLMODULEPATH -Encoding UTF8 
    }
    catch {        
...
function DOWNLOADMZTOOL {
    ...
    if ($MZTOOLURL) {
        ...
        do {
            ...
            DOWNLOAD -Urls $MZTOOLURL -Destination $MZTOOLZIP -BarWidth 30
            ...
            if (-not $MZTOOLZIPHASH -or $TRYGETMZTOOLZIP -ge 3) {                              
                Write-Warning "FALHA NA VERIFICAÇÃO DA HASH DO ARQUIVO."
                Start-Sleep -Seconds 3
        ...
        Write-Warning "NENHUMA CONEXÃO DISPONÍVEL NO MOMENTO. RETORNANDO AO MENU."
        Start-Sleep -Seconds 3
        DISPLAYMENU
    } 
}
        ...
        function DOWNLOADOFFICE2007 {   
            ...
            do {
                ...
                if ($TRYGETOFFICE2007ZIP -ge 5) {
                    ...
                    Write-Warning "FALHA NO CARREGAMENTO DO ARQUIVO. RETORNANDO AO MENU."
                    Start-Sleep -Seconds 3
                    DISPLAYMENU
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCADn6MWF6uqQ1bb
# 6yKGCFbjM7saoq9YqqORT/e4Ate/8aCCAxIwggMOMIIB9qADAgECAhAu1Cpzk/6k
...
# CzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIB+zJeSQnuJcPEeisvgA
# rDKHaMZP4DVQKxFNFrgi6O/2MA0GCSqGSIb3DQEBAQUABIIBAC9YLLXvZTpYGUuS
# 1DFjD75THdMP8FzmkU9CHgEsBGrLtayqNzBGtYFPtnes7P3PZK0hoqYdou6g/tqh
# 9x6wrLKP6E1J4gCqKL87Ru0lVc7HUQY3+O1D7Ncc0IrlZlrnaGwWibSZfqRIpHgG
# n5k+NkyY9H4agZVGIFuLgUh/Z/KY6myX91WIV98LMSp2Atg3DFtUMx85P2iDkgvq
# WU/ZCYBLfbMQVoq2kpH6L/mPcMdQjfcBSpB/Ztrx+jdYKofwZYJcAPR6d/A/+LwC
# rbiLL4qzcHfVIGLe0X2J28Z2vr8nR3/DM+11WWlSa0fKhZyfcScunSvThPMyzAX6
# i2jr2bM=
